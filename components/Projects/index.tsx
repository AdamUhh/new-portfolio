...
function ProjectCard({
    ...
    return (
        <div className="relative aspect-10/11 w-full rounded bg-[#252526] transition-transform after:absolute after:inset-0 after:bg-transparent after:transition-colors after:duration-500 hover:scale-105 hover:cursor-pointer hover:after:bg-accent/5">
